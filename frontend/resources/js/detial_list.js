...
/*咨询上部 开始*/
var proIntro1=byid('producer_intro1'),
	proIntro2=byid('producer_intro2'),
	pageRight1=byid('page_right1'),
	pageLeft2=byid('page_left2');

	pageRight1.addEventListener('click',function(){
		hide(proIntro1);
		show(proIntro2);
	});
	pageLeft2.addEventListener('click',function(){
		hide(proIntro2);
		show(proIntro1);
	})
/*咨询上部 结束*/

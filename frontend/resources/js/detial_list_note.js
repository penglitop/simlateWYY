...
/*信息提示 开始*/
;(function(prompt){
	var proBtn=byid('prompt_txt_btn'),
		prompt=byid('prompt');
...
/*课时 开始*/
var periodBtn=byid('period').getElementsByTagName('a'),
	activeInd=0;
	for(var i=0;i<periodBtn.length;i++){
		periodBtn[i].index=i;
		periodBtn[i].addEventListener('click',function(){
			if(!hasClass(this,'active')){
				removeClass(periodBtn[activeInd],'active');
